FORMS = {
    "A. Preliminary_assessment": {
        "form_id": "A. Preliminary_assessment",
        ...
        "column_labels": {"geo-district": "District","geo-block": "Block","geo-gp": "GP","geo-village": "village","geo-village_gps": "Village GPS","pa-work": "Type of work","pa-water_storage_months": "No.of months water will store","pa-gps": "Structure GPS","pa-total_hhs": "Total HHs","pa-pvtg_hhs": "PVTG HHs","pa-irrigated_hhs": "HHs undedr irrigation","pa-irrigated_acres": "Present irrigated area","pa-pipeline_suitable": "Suitable for pipeline","pa-checkdam": "Checkdam available","pa-applied_for_grant": "Applied for grant","pa-applied_in": "Applied in","pa-working_ngo": "Working NGO","pa-ngo": "NGO name","pa-grazing": "Grazing type","pa-contribution": Community ready for contribution","pa-irrigated_ext_rabi": "Irrigated extent in Rabi","pa-need_to_work": "Need to work","pa-village_person_name": "Name of the Village cont person","pa-village_person_phone": "Phone no","pa-survey_by": "Survey by"},
