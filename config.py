FORMS = {
    "1. Basic Information": {
        "form_id": "Basic_info",
        "columns": ["geo-district","geo-block","geo-gp","geo-village","Households-community","Households-total_hhs","Households-whs-hhs_covered","Households-population","enumerator-Jalamithra"],
        "column_labels": {"geo-district": "District","geo-block": "Block","geo-gp": "GP","geo-village": "Village","Households-community": "Community","Households-total_hhs": "Total HHs",""Households-whs-hhs_covered": "Househods covered","Households-population": "Population","enumerator-Jalamithra": "Jalamithra"},
